...
to_abstract_value(p::Abstractor{SeparateAxis}, source_value::Tuple{Int,Int}) =
    Dict(p.output_keys[1] => (source_value[1], 0), p.output_keys[2] => (0, source_value[2]))

to_abstract_value(p::Abstractor{SeparateAxis}, source_value::AbstractVector{Tuple{Int,Int}}) = Dict(
...
from_abstract_value(
    ...
    coord1::AbstractVector{Tuple{Int,Int}},
    coord2::AbstractVector{Tuple{Int,Int}},

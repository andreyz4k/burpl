...
@testset "Repeat object infinite" begin
    @testset "simple repeat" begin
        value = Set([Object([1], (1, 1)), Object([1], (2, 1)), Object([1], (3, 1))])
    ...
    @testset "different objects" begin
        value = Set([Object([1], (1, 1)), Object([1 1], (2, 1)), Object([1], (3, 1))])
        data = Dict("effective" => false)
    ...
    @testset "not infinite" begin
        ...
        @test data["effective"] == true
        value = Set([Object([1], (1, 1)), Object([1], (2, 1)), Object([1], (3, 1)), Object([1], (4, 1))])
        data = Dict("effective" => false)
        @test check_task_value(RepeatObjectInfinite(), value, data, [(4, 4)]) == true
        @test data["effective"] == true
        value = Set([Object([1], (2, 1)), Object([1], (3, 1))])
        data = Dict("effective" => false)
    ...
    @testset "repeat object" begin
        ...
        abs_data = make_taskdata(
            Dict("input|key|first" => Object([1], (1, 1)), "input|key|step" => (1, 1), "input|grid_size" => (3, 3)),
        )
        ...
        abs_data = make_taskdata(
            Dict("input|key|first" => Object([1], (3, 3)), "input|key|step" => (-1, -1), "input|grid_size" => (3, 3)),
        )
        reversed_data = repeater(abs_data)
    ...
    @testset "get object repeater" begin
        solution = make_dummy_solution([
            Dict("input|key" => Set([Object([1], (1, 1)), Object([1], (2, 3))]), "input|grid_size" => (3, 3)),
            Dict("input|key" => Set([Object([1], (1, 1))]), "input|grid_size" => (3, 3)),
            Dict(
                "input|key" => Set([Object([1], (1, 1)), Object([1], (2, 2)), Object([1], (3, 3))]),
                "input|grid_size" => (3, 3),
            ),
        ...
        solution = make_dummy_solution([
            ...
            Dict("input|key" => Set([Object([1], (1, 1))]), "input|grid_size" => (3, 3)),
            Dict(
                "input|key" => Set([Object([1], (1, 1)), Object([1], (2, 3)), Object([1], (3, 3))]),
                "input|grid_size" => (3, 3),
            ),
        ])

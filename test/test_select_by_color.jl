...
@testset "Select Objects by color" begin
    @testset "select objects" begin
        ...
        @test output_data == Dict(
            ...
            "selector_key" => 0,
            "key|selected_by_color|selector_key" => [
                Object([0 0], (1, 1)),
                Object([0; 0], (3, 2)),
            ],
            "key|rejected_by_color|selector_key" => [
                Object([1], (4, 1)),
                Object([2], (1, 5)),
            ]
        )
    ...
    @testset "create selector" begin
        ...
        @test abstractor.to_abstract.output_keys == ["input|key|selected_by_color|input|selector_key", "input|key|rejected_by_color|input|selector_key"]
        @test abstractor.from_abstract == SelectColor("input|key", "input|selector_key", false)
        @test abstractor.from_abstract.input_keys == ["input|key|selected_by_color|input|selector_key", "input|key|rejected_by_color|input|selector_key"]
